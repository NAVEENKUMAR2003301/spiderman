    ...
    >
      ...
      <ul className="nav-links">
        {links.map((l, i) => (
          ...
          >
            <a href={`#${l.toLowerCase()}`} data-hover>{l}</a>
          </motion.li>
        ))}
      </ul>

      <button className="nav-cta" data-hover>JOIN THE FIGHT</button>

      <button className="burger" onClick={() => setMenuOpen(!menuOpen)} data-hover>
